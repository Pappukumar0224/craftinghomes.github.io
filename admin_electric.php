...
<div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM crafhomedb.bookings,crafhomedb.service where s_name=reqest and s_id > 505 and s_id <605 ";
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<form action='admin_electric_update.php' method='post'>";
