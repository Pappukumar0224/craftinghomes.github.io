...
<div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM crafhomedb.bookings,crafhomedb.service where s_name=reqest and s_id > 205 and s_id<305 ";
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<form action='admin_carpenter_update.php' method='post'>";
