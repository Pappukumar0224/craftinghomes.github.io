...
<div class="container">
        ...
        <table>
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM crafhomedb.bookings,crafhomedb.service where s_name=reqest and s_id > 105 and s_id<205 ";
                ...
                while($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td>";
                    echo "<form action='admin_clean_update.php' method='post'>";
