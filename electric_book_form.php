    ...
    <div class="container">
        ...
        <form action="submit_booking.php" method="POST" onsubmit="return validateForm()">
            ...
            <div class="form-group">
                ...
                <select id="requirements" name="requirements" single ="singal" class="js-example-basic-multiple" required>
                    <option value="Electrical Installation and Repairs">Electrical Installation and Repairs</option>
                    <option value="Electrical Wiring and Rewiring">Electrical Wiring and Rewiring</option>
                    <option value="Emergency Electrical Services">Emergency Electrical Services</option>
                    <!-- <option value="Refinishing and Repair">Refinishing and Repair</option> -->
                </select>
            </div>
            <div class="form-group">
